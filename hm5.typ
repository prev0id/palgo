...
+ Получается по дереву из п.2 мы можем за $log sqrt(n)$ найти пару для каждой оставшейся скобки
  - Для $"open"[i][j]$ (j-я открывающаяся скобка из i-го блока).
      ...
      - Cпускаемся по по правому поддереву найденной вершины, ищя закрывающуюся скобку с нужным индексом, мы можем это сделать так как каждая вершина хранит количество скобок без пар
